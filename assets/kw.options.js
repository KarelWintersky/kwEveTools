 ...
 * default_option    =       false или объект со значениями по умолчанию (вверху списка)
 *                           {
 ...
 *                           загрузки списка
 * Example:
 * BuildSelectorExpert('charlist', $.parseJSON(data), { text: 'Select', 'value' : 0 }, 825229640);
 * */
function BuildSelectorExpert(target_name, selector_data, default_option, value_of_selected_option )
{
